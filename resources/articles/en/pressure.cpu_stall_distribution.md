...
[日本語版](../ja/pressure.cpu_stall_distribution.md)

---

Part of the **[PSI (Pressure Stall Information)](pressure.cpu_some_avg10.md)** metrics — see the `avg10` article for full context.

`cpu_stall_distribution` — Distribution of CPU stall events across processes.
...
- `pressure.cpu_some_avg10` — primary article with context and thresholds
